...
@Component({
  selector: 'app-mushroom-dump',
  imports: [FormsModule, DecimalPipe],
  templateUrl: './mushroom-dump.component.html',
  styleUrl: './mushroom-dump.component.scss',
})
export class MushroomDumpComponent implements OnInit {
